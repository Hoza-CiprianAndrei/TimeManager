defmodule Todolist.TimeTrackingTest do
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2026-09-21 08:46:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2026-09-21 08:46:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2026-09-22 08:46:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2026-09-22 08:46:00]
    end
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2026-09-21 08:47:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2026-09-21 08:47:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2026-09-22 08:47:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2026-09-22 08:47:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{start: ~N[2026-09-21 08:47:00], end: ~N[2026-09-21 08:47:00]}

      assert {:ok, %WorkingTime{} = working_time} = TimeTracking.create_working_time(valid_attrs)
      assert working_time.start == ~N[2026-09-21 08:47:00]
      assert working_time.end == ~N[2026-09-21 08:47:00]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{start: ~N[2026-09-22 08:47:00], end: ~N[2026-09-22 08:47:00]}

      assert {:ok, %WorkingTime{} = working_time} = TimeTracking.update_working_time(working_time, update_attrs)
      assert working_time.start == ~N[2026-09-22 08:47:00]
      assert working_time.end == ~N[2026-09-22 08:47:00]
    end
  ...
  describe "clocks" do
    ...
    test "create_clock/1 with valid data creates a clock" do
      valid_attrs = %{status: true, time: ~N[2026-09-21 09:10:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.create_clock(valid_attrs)
      assert clock.status == true
      assert clock.time == ~N[2026-09-21 09:10:00]
    end
    ...
    test "update_clock/2 with valid data updates the clock" do
      clock = clock_fixture()
      update_attrs = %{status: false, time: ~N[2026-09-22 09:10:00]}

      assert {:ok, %Clock{} = clock} = TimeTracking.update_clock(clock, update_attrs)
      assert clock.status == false
      assert clock.time == ~N[2026-09-22 09:10:00]
    end
  ...
  describe "workingtimes" do
    ...
    test "create_working_time/1 with valid data creates a working_time" do
      valid_attrs = %{start: ~N[2026-09-21 09:11:00], end: ~N[2026-09-21 09:11:00]}

      assert {:ok, %WorkingTime{} = working_time} = TimeTracking.create_working_time(valid_attrs)
      assert working_time.start == ~N[2026-09-21 09:11:00]
      assert working_time.end == ~N[2026-09-21 09:11:00]
    end
    ...
    test "update_working_time/2 with valid data updates the working_time" do
      working_time = working_time_fixture()
      update_attrs = %{start: ~N[2026-09-22 09:11:00], end: ~N[2026-09-22 09:11:00]}

      assert {:ok, %WorkingTime{} = working_time} = TimeTracking.update_working_time(working_time, update_attrs)
      assert working_time.start == ~N[2026-09-22 09:11:00]
      assert working_time.end == ~N[2026-09-22 09:11:00]
    end
